...
app.get("/oea", function (sol, res) {
    ...
    pagina.diretores = [
        ...
        },
        {
            ...
            descricao: [
                "Anna é uma pseudo comunista que está se achando, pois iniciou seus estudos em direito na USP em 2018. Vale dizer que é uma garota prendada, chata, às vezes simpática, maluca, ansiosa e que ama política e pessoas engajadas. Apesar de ser uma amante de memes, descobrirão, em breve, que a graça não é seu forte, e por isso essa introdução não está sendo escrita por ela, mas sim pela sua fã número 1. Geralmente não presta atenção no que os outros falam, porém, por incrível que pareça, tem o superpoder de focar dentro de uma sala de comitê. Talvez seja por conta dessa vantagem apelona sobre os meros mortais que obteve vitoriosas experiências no ramo das simulações. A leonina promete não deixar que sua teimosia afete a vivência de vocês delegados. Entretanto, não deixem de ser cautelosos perto dela, já que seu ascendente é em escorpião e ela pode ser facilmente irritada."
            ]
        },
        {
            nome: "Bruno Fiorelli",
